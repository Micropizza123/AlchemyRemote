...
public class SpellBookGuiGuiWindow extends ContainerScreen<SpellBookGuiGui.GuiContainerMod> {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.guiLeft + -6, this.guiTop + -22, 0, 0, 200, 200, 200, 200);
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "SpellBook", 60, -5, -13434676);
		this.font.drawString(ms, "Skills only work if you", 27, 3, -3407872);
		this.font.drawString(ms, "have them unlocked!", 27, 14, -3407872);
	}
