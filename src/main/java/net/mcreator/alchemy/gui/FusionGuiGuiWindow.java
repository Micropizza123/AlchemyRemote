...
@OnlyIn(Dist.CLIENT)
public class FusionGuiGuiWindow extends ContainerScreen<FusionGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = FusionGuiGui.guistate;
	public FusionGuiGuiWindow(FusionGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("alchemy:textures/fusion_gui.png");
	@Override
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 76, this.guiTop + 54, 50, 20, new StringTextComponent("Fuse"), e -> {
			if (true) {
