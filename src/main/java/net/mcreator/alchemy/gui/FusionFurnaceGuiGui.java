...
public class FusionFurnaceGuiGui extends AlchemyModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public FusionFurnaceGuiGui(AlchemyModElements instance) {
		super(instance, 199);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("fusion_furnace_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, FusionFurnaceGuiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 109, 47) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
