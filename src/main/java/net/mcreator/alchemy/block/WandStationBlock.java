...
import net.mcreator.alchemy.gui.WandStationGuiGui;
...
public class WandStationBlock extends AlchemyModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Used to add or remove powers and upgrades to the magic staff!"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Wand Station");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new WandStationGuiGui.GuiContainerMod(id, inventory,
