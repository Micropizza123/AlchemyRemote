...
import net.mcreator.alchemy.item.GreenCrystalShardItem;
...
public class GreenCrystalBlockBlock extends AlchemyModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GreenCrystalShardItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("alchemy:green_crystal_block_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("alchemy:green_crystal_block"), configuredFeature);
		}
	}
	@SubscribeEvent
