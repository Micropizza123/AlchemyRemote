...
import net.mcreator.alchemy.procedures.IcestagaliteUpdateTickProcedure;
...
public class IcestagaliteBlock extends AlchemyModElements.ModElement {
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				IcestagaliteUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	}
