...
import net.mcreator.alchemy.procedures.GinsengUpdateTickProcedure;
...
public class GinsengBlock extends AlchemyModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ginseng"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("alchemy:ginseng"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				GinsengUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
