...
public class MagentaDiamondOreBlock extends AlchemyModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MagentaDiamondOreBlock.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("alchemy:magenta_diamond_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("magenta_diamond_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("alchemy:magenta_diamond_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
