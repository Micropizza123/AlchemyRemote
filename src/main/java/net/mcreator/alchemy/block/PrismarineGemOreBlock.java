...
public class PrismarineGemOreBlock extends AlchemyModElements.ModElement {
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == InfestedgrassBlock.block)
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("alchemy:prismarine_gem_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("prismarine_gem_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("alchemy:prismarine_gem_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
