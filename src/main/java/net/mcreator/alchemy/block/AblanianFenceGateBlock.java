...
public class AblanianFenceGateBlock extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:ablanian_fence_gate")
	public static final Block block = null;
	public AblanianFenceGateBlock(AlchemyModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ablanian_fence_gate");
		}
