...
import net.mcreator.alchemy.entity.renderer.TeleportationstaffRenderer;
...
public class TeleportationstaffItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:teleportationstaff")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("teleportationstaff");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Teleport"));
		}
