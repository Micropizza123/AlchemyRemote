...
import net.mcreator.alchemy.procedures.LightningStrikePowerRightClickedInAirProcedure;
...
public class LightningStrikePowerItem extends AlchemyModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lightning_strike_power");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Right Click to summon 8 lightning around you!"));
			list.add(new StringTextComponent("\u00A73Mana Cost:\u00A75 5"));
