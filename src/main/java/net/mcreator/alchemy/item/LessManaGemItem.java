...
public class LessManaGemItem extends AlchemyModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Staff Upgrade: Reduces the amount of Mana you use when you use a spell using the \u00A7dStaff!"));
