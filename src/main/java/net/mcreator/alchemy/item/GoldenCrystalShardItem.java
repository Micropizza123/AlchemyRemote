...
public class GoldenCrystalShardItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:golden_crystal_shard")
	public static final Item block = null;
	public GoldenCrystalShardItem(AlchemyModElements instance) {
		super(instance, 45);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("golden_crystal_shard");
		}
