...
import net.mcreator.alchemy.procedures.WaterPowerRangedWhileBulletFlyingTickProcedure;
import net.mcreator.alchemy.procedures.WaterPowerRangedBulletHitsBlockProcedure;
import net.mcreator.alchemy.entity.renderer.WaterPowerRangedRenderer;
...
public class WaterPowerRangedItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:water_power_ranged")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("water_power_ranged");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			Entity imediatesourceentity = this;
			{
				...
				WaterPowerRangedBulletHitsBlockProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick() {
			...
			Entity imediatesourceentity = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				WaterPowerRangedWhileBulletFlyingTickProcedure.executeProcedure($_dependencies);
			}
			if (this.inGround) {
				{
					Map<String, Object> $_dependencies = new HashMap<>();
