...
import net.mcreator.alchemy.procedures.EnderenergymeterRightClickedOnBlockProcedure;
...
public class EnderenergymeterItem extends AlchemyModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("enderenergymeter");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				EnderenergymeterRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
