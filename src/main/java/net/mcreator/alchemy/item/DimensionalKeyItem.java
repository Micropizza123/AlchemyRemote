...
import net.mcreator.alchemy.procedures.DimensionalKeyRightClickedOnBlockProcedure;
...
public class DimensionalKeyItem extends AlchemyModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(AlchemyItemGroup.tab).maxDamage(342).rarity(Rarity.RARE));
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				DimensionalKeyRightClickedOnBlockProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
