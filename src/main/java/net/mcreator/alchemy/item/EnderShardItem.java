...
public class EnderShardItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:ender_shard")
	public static final Item block = null;
	public EnderShardItem(AlchemyModElements instance) {
		super(instance, 136);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7eRare item"));
		}
	}
}
