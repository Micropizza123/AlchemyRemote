...
public class MagentaCrystalShardItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:magenta_crystal_shard")
	public static final Item block = null;
	public MagentaCrystalShardItem(AlchemyModElements instance) {
		super(instance, 53);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magenta_crystal_shard");
		}
