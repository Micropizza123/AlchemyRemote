...
public class BlackDiamondItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:black_diamond")
	public static final Item block = null;
	public BlackDiamondItem(AlchemyModElements instance) {
		super(instance, 17);
	}
