...
public class GinsengRegenerationItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:ginseng_regeneration")
	public static final Item block = null;
	public GinsengRegenerationItem(AlchemyModElements instance) {
		super(instance, 148);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("ginseng_regeneration");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Regeneration I"));
