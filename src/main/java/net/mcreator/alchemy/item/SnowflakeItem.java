...
import net.mcreator.alchemy.entity.renderer.SnowflakeRenderer;
import net.mcreator.alchemy.AlchemyModElements;

import java.util.Random;

@AlchemyModElements.ModElement.Tag
public class SnowflakeItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:snowflake")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(AlchemyItemGroup.tab).maxDamage(4062));
