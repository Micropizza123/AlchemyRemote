...
import net.mcreator.alchemy.entity.renderer.GlockRenderer;
...
public class GlockItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:glock")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(AlchemyItemGroup.tab).maxDamage(100));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A Gun"));
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 50f, 1, 0);
