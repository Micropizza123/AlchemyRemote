...
import net.mcreator.alchemy.gui.BackpackGuiGuiWindow;
import net.mcreator.alchemy.gui.BackpackGuiGui;
...
public class BackpackItem extends AlchemyModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("More Inventory"));
		}
