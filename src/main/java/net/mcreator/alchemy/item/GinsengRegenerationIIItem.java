...
import net.mcreator.alchemy.procedures.GinsengRegenerationIIEatenProcedure;
...
public class GinsengRegenerationIIItem extends AlchemyModElements.ModElement {
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			...
			setRegistryName("ginseng_regeneration_ii");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Regeneration II"));
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				GinsengRegenerationIIEatenProcedure.executeProcedure($_dependencies);
			}
