...
public class SoulFragmentItem extends AlchemyModElements.ModElement {
	@ObjectHolder("alchemy:soul_fragment")
	public static final Item block = null;
	public SoulFragmentItem(AlchemyModElements instance) {
		super(instance, 130);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Soul"));
