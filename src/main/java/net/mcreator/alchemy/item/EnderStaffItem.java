...
import net.mcreator.alchemy.procedures.EnderStaffRightClickedInAirProcedure;
...
public class EnderStaffItem extends AlchemyModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Shoot Dragon fireballs"));
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			double z = entity.getPosZ();
			{
				...
				EnderStaffRightClickedInAirProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
	}
