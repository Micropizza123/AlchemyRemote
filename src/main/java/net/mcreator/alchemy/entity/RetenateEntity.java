...
package net.mcreator.alchemy.entity;
...
import net.mcreator.alchemy.item.RetenatestickItem;
import net.mcreator.alchemy.entity.renderer.RetenateRenderer;
import net.mcreator.alchemy.AlchemyModElements;

@AlchemyModElements.ModElement.Tag
public class RetenateEntity extends AlchemyModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16775910, -16642304, new Item.Properties().group(AlchemyItemGroup.tab))
				.setRegistryName("retenate_spawn_egg"));
	}
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 8;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.OFFHAND, new ItemStack(RetenatestickItem.block));
		}
