...
import net.mcreator.alchemy.entity.renderer.HeroBrineRenderer;
import net.mcreator.alchemy.AlchemyModElements;

import java.util.Random;

@AlchemyModElements.ModElement.Tag
public class HeroBrineEntity extends AlchemyModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("hero_brine").setRegistryName("hero_brine");
	public HeroBrineEntity(AlchemyModElements instance) {
		super(instance, 1);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -65536, new Item.Properties().group(AlchemyItemGroup.tab))
				.setRegistryName("hero_brine_spawn_egg"));
	}
	...
	public static class CustomEntity extends ZombieEntity {
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.player.burp")), 0.15f,
					1);
		}
