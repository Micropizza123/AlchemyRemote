...
import net.mcreator.alchemy.block.SakuraleavesBlock;
...
public class SakuraforestBiome extends AlchemyModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-16711799).setWaterFogColor(-16728474)
						.withSkyColor(7972607).withFoliageColor(-4238862).withGrassColor(9470285).build();
				...
				event.getRegistry().register(biome.setRegistryName("alchemy:sakuraforest"));
			}
		}
	}
	@Override
